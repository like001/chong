...
//    private static final int HEIGHT = 700;
    ...
    private static final int FIRST_TAP_Y = 714;
    private static final int STEP_Y = 174;
    private OCR ocr;
    private Utils utils;
...
//        imagePath = "D:\\Photo\\test1.png";
        ...
        FutureTask futureQuestion = new FutureTask<Long>(new BaiDuSearch(information.getQuestion(), true));
        ...
        int tapPos = getTapPos(maxIndex,numOfAnswer);
        utils.tap(tapPos);
        //根据pmi值进行打印搜索结果
    ...
    private int getTapPos(int maxIndex, int numOfAnswer) {
        return FIRST_TAP_Y+maxIndex*STEP_Y;
    }
}
