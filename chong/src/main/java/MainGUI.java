...
public class MainGUI {
    ...
    private static ButtonGroup patSelectionButton=new ButtonGroup();
...
//    创建文本域用于用户输入adb路径
    private static void addAdbPath(JPanel panel) {
        ...
        adbPathText = new JTextField("D:\\as\\sdk\\platform-tools\\", 30);
    ...
    private static void addPatternSelection(JPanel panel) {
        JLabel ocrSelectionLabel = new JLabel("答题方式：");
        ocrSelectionLabel.setBounds(10, 80, 100, 25);
        addParttenSelection(panel,100,"百万英雄",1);
        addParttenSelection(panel,300,"冲顶大会",2);
        panel.add(ocrSelectionLabel);
    }
    ...
    private static void addParttenSelection(JPanel panel, int X, String text, final int selection){
        final JRadioButton ocrButton=new JRadioButton(text);
        ocrButton.setBounds(X, 80, 165, 25);
        patSelectionButton.add(ocrButton);
        panel.add(ocrButton);
        ActionListener listener=new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private static void addSetFinishButton(JPanel panel){
        ...
        setFinishButton.setBounds(40, 120, 100, 25);
    ...
    private static void addRunButton(JPanel panel){
        ...
        runButton.setBounds(160, 120, 100, 25);
        panel.add(runButton);
        ActionListener listener=new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    private static void addResultTextArea(JPanel panel) {
        ...
        resultTextArea.setBounds(10, 160, 400, 400);
